 ...
 *
 * <p>BasicAuthInfo contains the authentication information needed for BASIC authentication (extending AuthInfo which
 * has all common auth info in it)
 *
 * <p>BASIC authentication in PHP:
 *
 * <ul>
 *   <li>http://php.net/manual/en/features.http-auth.php
