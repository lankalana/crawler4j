...
public class HostDirectives {
	...
	/**
	 * Change the user agent string used to crawl after initialization. This will reorder (recreate) the list of user
	 * agent directives for this host.
	 *
	...
	public void setUserAgent(String userAgent) {
		...
		// Re-order the set
		Set<UserAgentDirectives> replace =
				new TreeSet<UserAgentDirectives>(new UserAgentDirectives.UserAgentComparator(this.userAgent));
