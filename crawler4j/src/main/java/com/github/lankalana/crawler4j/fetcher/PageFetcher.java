...
import com.github.lankalana.crawler4j.crawler.authentication.BasicAuthInfo;
import com.github.lankalana.crawler4j.crawler.authentication.FormAuthInfo;
import com.github.lankalana.crawler4j.crawler.authentication.NtAuthInfo;
...
public class PageFetcher {
	...
	/**
	 * This field is protected for retro compatibility. Please use the getter method: getConfig() to read this field;
	 */
	...
	private void doFormLogin(FormAuthInfo authInfo) {
		...
		try {
			...
			logger.debug(
					"Successfully request to login in with user: {} to: {}",
					authInfo.getUsername(),
					authInfo.getHost());
	...
	/**
	 * Creates a new HttpUriRequest for the given url. The default is to create a HttpGet without any further
	 * configuration. Subclasses may override this method and provide their own logic.
	 *
