...
public class Page {
	...
	/**
	 * Read contents from an entity, with a specified maximum. This is a replacement of EntityUtils.toByteArray because
	 * that function does not impose a maximum size.
	 *
