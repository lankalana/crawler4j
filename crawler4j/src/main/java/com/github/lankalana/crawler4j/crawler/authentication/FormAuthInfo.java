package com.github.lankalana.crawler4j.crawler.authentication;
 ...
 *
 * <p>FormAuthInfo contains the authentication information needed for FORM authentication (extending AuthInfo which has
 * all common auth info in it) Basically, this is the most common authentication, where you will get to a site and you
 * will need to enter a username and password into an HTML form
 */
public class FormAuthInfo extends AuthInfo {
	 ...
	 */
	public FormAuthInfo(
			String username, String password, String loginUrl, String usernameFormStr, String passwordFormStr)
