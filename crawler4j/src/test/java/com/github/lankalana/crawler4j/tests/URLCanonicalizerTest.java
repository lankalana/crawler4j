package com.github.lankalana.crawler4j.tests;
...
public class URLCanonicalizerTest {
	...
	public void testCanonizalier() throws UnsupportedEncodingException {
		...
		assertEquals(
				"http://www.example.com/?q=a%2Bb", URLCanonicalizer.getCanonicalURL("http://www.example.com/?q=a+b"));
		...
		assertEquals(
				"http://www.example.com/3.asp?DengJh=%BA%E91700718",
				URLCanonicalizer.getCanonicalURL(
						"3.asp?DengJh=洪1700718", "http://www.example.com", Charset.forName("gb2312")));
		...
		assertEquals(
				"http://www.example.com/search/?query=hello%E3%80%80world",
